...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FCFCFB] grid lg:grid-cols-2">
      <div className="hidden lg:flex flex-col justify-between p-12 bg-[#3A4F41] text-[#FCFCFB] relative">
        ...
        <div className="text-[11px] tracking-widest uppercase opacity-60 relative z-10">
          Phase 1 · Multi-tenant Console
        </div>
      </div>
      ...
      <div className="flex items-center justify-center px-8 py-16">
        <form onSubmit={onSubmit} className="w-full max-w-sm">
          ...
          <p className="text-sm text-[#666666] mb-10">
            Use the email your platform admin gave you.
          </p>
          ...
          <div className="space-y-5">
            ...
            {error && (
              <div
                data-testid={TID.loginError}
                className="text-sm text-[#C84C4C] border-l-2 border-[#C84C4C] pl-3 py-1"
              >
                {error}
              </div>
            )}
